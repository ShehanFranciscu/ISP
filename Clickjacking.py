...
<html>
	...
	<body>
        ...
        <h2 style="text-align: center;">YAKA Clickjacking Tester</h2>
        <h3 style="text-align: center;">Ravindu Pabasara(IT20118204) and Shehan Franciscu(IT20017910)</h3>
        <hr>
...
print('\n[+] Thanks for using YAKA Clickjacking Tester ;-) ')
print('\n ----------------- Created by Ravindu Pabasara(IT20118204) and Shehan Franciscu(IT20017910) -----------------')
print('\n')